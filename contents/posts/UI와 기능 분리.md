...
author: jangky000
date: 2022.02.19
desc: 협업을 하다보면 남이 짠 코드를 읽고 새로운 기획에 맞게 수정해서 사용하는 경우가 많다. 재사용성을 고려하여 잘 짜여진 코드라면 쉽게 수정이 가능하겠지만, 미래의 모든 변경 사항을 예측해서 코드를 작성할 수 없을 뿐더러, 충분히 고민할 수 있는 시간이 없었을 수 있다. 협업하고 성장해가는 과정에 서로의 코드를 보듬어줄 수 있어야 좋은 개발자인 것 같다. 아무튼 이번 작업에서는 재사용성을 고려하여 UI와 기능을 분리해본 경험을 공유하고자 한다.
---
